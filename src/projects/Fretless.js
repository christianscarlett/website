...
import Post, {center, rotate} from '../templates/Post';
    ...
    return (
      <Post 
        ...
        content={(
          ...
          <div style={Object.assign({}, rotate)}>
            <img src={require('../images/bass_before.jpg')} alt="" style={Object.assign({}, center, {})}></img> 
          </div>
          ...
          <div style={Object.assign({}, center)}>
            <img src={require('../images/bass_dramatic_1.jpg')} alt="" style={{width: 60+'%'}}></img>
